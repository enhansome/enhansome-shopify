...
* [Shopify Dawn](https://github.com/Shopify/dawn) ⭐ 3,071 | 🐛 23 | 🌐 Liquid | 📅 2026-08-10 - Official Online Store 2.0 theme.
...
* [Hydrogen](https://hydrogen.shopify.dev) - Headless stack for custom storefronts. [Source code](https://github.com/Shopify/hydrogen) ⭐ 2,113 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-07.
...
* [Pilot (Weaverse Hydrogen Theme)](https://github.com/Weaverse/pilot) ⭐ 193 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-07 - Fully featured Shopify Hydrogen theme crafted for launching modern, high-performance headless storefronts. Includes TypeScript, Tailwind CSS, GraphQL code generation, React Router, Oxygen deployment, and customization via Weaverse Studio. 🚀
...
* [AEOrank](https://github.com/vinpatel/aeorank/tree/main/packages/shopify) ⭐ 14 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-07 - Hydrogen plugin that generates AI-readable files (llms.txt, ai.txt, CLAUDE.md, schema.json) so ChatGPT and Perplexity can find and cite your products.
...
* [Shopify Vite](https://github.com/barrel/shopify-vite) ⭐ 462 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-17 - Modern frontend tooling for Shopify theme development using Vite for a best-in-class DX.
...
* [Shopify Checkout Sheet Kit (React Native)](https://github.com/Shopify/checkout-sheet-kit-react-native) ⭐ 80 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-04
* [Shopify Checkout Sheet Kit (Swift)](https://github.com/Shopify/checkout-sheet-kit-swift) ⭐ 66 | 🐛 11 | 🌐 Swift | 📅 2026-08-24
...
* [Shopify API and app tools for JavaScript](https://github.com/Shopify/shopify-app-js) ⭐ 538 | 🐛 129 | 🌐 TypeScript | 📅 2026-09-04
* [nestjs-shopify](https://github.com/nestjs-shopify/nestjs-shopify) ⭐ 151 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-07 - Packages to develop Shopify application using NestJS.
...
* [orbit-apps/elixir-shopifyapi](https://github.com/orbit-apps/elixir-shopifyapi) ⭐ 32 | 🐛 15 | 🌐 Elixir | 📅 2026-09-07 - ShopifyAPI and Plug.ShopifyAPI Elixir client.
...
* [Shopify App Template (React Router)](https://github.com/Shopify/shopify-app-template-react-router) ⭐ 196 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-07 - Template for Shopify apps using React Router for routing instead of Next.js or Remix.
* [Shopify Payments App Template (Remix)](https://github.com/Shopify/example-app--payments-app-template--remix) ⭐ 27 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-07 - Remix template for building Shopify apps with payments integration (Payments App API support). 🚀
* [Shopify Credit Card Payments Template (Remix)](https://github.com/Shopify/example-app--credit-card-payments-app-template--remix) ⭐ 16 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-07 - Remix example showing Credit Card Payments integration using Shopify’s Payments API. 🏦
...
* [Shopify CLI](https://github.com/Shopify/cli) ⭐ 741 | 🐛 151 | 🌐 TypeScript | 📅 2026-09-07 - CLI to build apps, themes, and hydrogen storefronts for Shopify 🚀.
...
* [Agent plugins/extensions for CLIs and IDEs](https://github.com/shopify/shopify-ai-toolkit) ⭐ 538 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-02
