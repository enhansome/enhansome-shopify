...
* [Shopify Dawn](https://github.com/Shopify/dawn) ⭐ 3,082 | 🐛 27 | 🌐 Liquid | 📅 2026-08-10 - Official Online Store 2.0 theme.
* [Shopify Horizon](https://github.com/Shopify/horizon) ⭐ 459 | 🐛 30 | 🌐 Liquid | 📅 2026-09-18 - Flagship of Shopify’s next-gen themes.
...
* [AEOrank](https://github.com/vinpatel/aeorank/tree/main/packages/shopify) ⭐ 14 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-19 - Hydrogen plugin that generates AI-readable files (llms.txt, ai.txt, CLAUDE.md, schema.json) so ChatGPT and Perplexity can find and cite your products.
...
* [Shopify UI Extensions](https://github.com/Shopify/ui-extensions) ⭐ 350 | 🐛 452 | 🌐 TypeScript | 📅 2026-09-18 – Repo for the public definition of Shopify’s UI extension APIs. Developers use this to build strongly-typed UI extensions for Shopify surfaces. 🧰
...
* [Shopify CLI](https://github.com/Shopify/cli) ⭐ 750 | 🐛 159 | 🌐 TypeScript | 📅 2026-09-18 - CLI to build apps, themes, and hydrogen storefronts for Shopify 🚀.
...
* [Agent plugins/extensions for CLIs and IDEs](https://github.com/shopify/shopify-ai-toolkit) ⭐ 555 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-18
