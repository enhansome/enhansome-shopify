...
* [Shopify Dawn](https://github.com/Shopify/dawn) ⭐ 3,083 | 🐛 27 | 🌐 Liquid | 📅 2026-08-10 - Official Online Store 2.0 theme.
* [Shopify Horizon](https://github.com/Shopify/horizon) ⭐ 460 | 🐛 30 | 🌐 Liquid | 📅 2026-09-18 - Flagship of Shopify’s next-gen themes.
* [City Ecommerce UI Kit](https://github.com/shopifypartners/City-Ecommerce-UI-Kit) ⭐ 33 | 🐛 0 | 📅 2017-06-16
...
* [Hydrogen](https://hydrogen.shopify.dev) - Headless stack for custom storefronts. [Source code](https://github.com/Shopify/hydrogen) ⭐ 2,131 | 🐛 109 | 🌐 TypeScript | 📅 2026-09-18.
* [Pilot (Weaverse Hydrogen Theme)](https://github.com/Weaverse/pilot) ⭐ 383 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-18 - Fully featured Shopify Hydrogen theme crafted for launching modern, high-performance headless storefronts. Includes TypeScript, Tailwind CSS, GraphQL code generation, React Router, Oxygen deployment, and customization via Weaverse Studio. 🚀
...
* [packdigital/pack-hydrogen-theme-blueprint](https://github.com/packdigital/pack-hydrogen-theme-blueprint) ⭐ 105 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-18 - A fully-featured Shopify Hydrogen starter theme packed with versatile components designed to seamlessly integrate with Pack and Shopify Hydrogen.
* [AEOrank](https://github.com/vinpatel/aeorank/tree/main/packages/shopify) ⭐ 14 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-20 - Hydrogen plugin that generates AI-readable files (llms.txt, ai.txt, CLAUDE.md, schema.json) so ChatGPT and Perplexity can find and cite your products.
* [mock.shop starter](https://github.com/Shopify/mock-shop-starter) ⭐ 1 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-18 - Official Hydrogen skeleton pre-wired to [mock.shop](https://mock.shop), Shopify's auth-free Storefront API with 100+ fictional stores. Runs with no store, app, or access token; switch stores with one env var.
...
* [Shopify Vite](https://github.com/barrel/shopify-vite) ⭐ 467 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-17 - Modern frontend tooling for Shopify theme development using Vite for a best-in-class DX.
* [Shopify UI Extensions](https://github.com/Shopify/ui-extensions) ⭐ 351 | 🐛 452 | 🌐 TypeScript | 📅 2026-09-18 – Repo for the public definition of Shopify’s UI extension APIs. Developers use this to build strongly-typed UI extensions for Shopify surfaces. 🧰
...
* [Shopify Checkout Sheet Kit (React Native)](https://github.com/Shopify/checkout-sheet-kit-react-native) ⭐ 80 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-18
* [Shopify Checkout Sheet Kit (Swift)](https://github.com/Shopify/checkout-sheet-kit-swift) ⭐ 66 | 🐛 9 | 🌐 Swift | 📅 2026-09-18
* [Shopify Checkout Sheet Kit (Android)](https://github.com/Shopify/checkout-sheet-kit-android) ⭐ 27 | 🐛 15 | 🌐 Kotlin | 📅 2026-09-18
...
* [A Rails Engine for building Shopify Apps](https://github.com/Shopify/shopify_app) ⭐ 1,932 | 🐛 58 | 🌐 Ruby | 📅 2026-08-24
* [Shopify Ruby API](https://github.com/Shopify/shopify_api) ⭐ 1,108 | 🐛 36 | 🌐 Ruby | 📅 2026-08-04
* [Shopify OAuth2 Strategy for OmniAuth](https://github.com/Shopify/omniauth-shopify-oauth2) ⭐ 92 | 🐛 19 | 🌐 Ruby | 📅 2026-03-27

### Python

* [Shopify Python API](https://github.com/Shopify/shopify_python_api) ⭐ 1,436 | 🐛 25 | 🌐 Python | 📅 2026-08-25
...
* [Shopify API and app tools for JavaScript](https://github.com/Shopify/shopify-app-js) ⭐ 540 | 🐛 134 | 🌐 TypeScript | 📅 2026-09-18
* [nestjs-shopify](https://github.com/nestjs-shopify/nestjs-shopify) ⭐ 151 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-19 - Packages to develop Shopify application using NestJS.

### DotNet

* [nozzlegear/ShopifySharp](https://github.com/nozzlegear/ShopifySharp) ⭐ 897 | 🐛 223 | 🌐 C# | 📅 2026-09-20 - A .NET library for Shopify.

### Elixir

* [orbit-apps/elixir-shopifyapi](https://github.com/orbit-apps/elixir-shopifyapi) ⭐ 32 | 🐛 15 | 🌐 Elixir | 📅 2026-09-16 - ShopifyAPI and Plug.ShopifyAPI Elixir client.
...
* [Shopify Java SDK](https://github.com/ChannelApe/shopify-sdk) ⭐ 175 | 🐛 39 | 🌐 Java | 📅 2024-10-18 - Java SDK for Shopify REST APIs.
...
* [Kyon147/laravel-shopify](https://github.com/Kyon147/laravel-shopify) ⭐ 496 | 🐛 30 | 🌐 PHP | 📅 2026-08-24 - A full-featured Laravel package for aiding in Shopify App development. ⏱
* [Shopify API Library for PHP](https://github.com/Shopify/shopify-api-php) ⭐ 473 | 🐛 52 | 🌐 PHP | 📅 2026-08-25 - Official library provides support for PHP Shopify apps to access the Shopify Admin API 🚀.
...
* [oseintow/laravel-shopify](https://github.com/oseintow/laravel-shopify) ⭐ 72 | 🐛 9 | 🌐 PHP | 📅 2023-08-29 - Laravel Shopify is a simple package which helps to build robust integration into Shopify. ⚠️
* [ZfrShopify](https://github.com/zf-fr/zfr-shopify) ⭐ 36 | 🐛 12 | 🌐 PHP | 📅 2023-07-15 - Guzzle client around Shopify API.
* [bold-shopify-toolkit](https://github.com/bold-commerce/bold-shopify-toolkit) ⭐ 26 | 🐛 8 | 🌐 PHP | 📅 2026-09-15 - A Symfony Based Shopify api wrapper.
...
* [Shopify Function Rust](https://github.com/Shopify/shopify-function-rust) ⭐ 47 | 🐛 11 | 🌐 Rust | 📅 2026-09-14
...
* [Shopify Rust Client](https://github.com/sinha-sahil/shopify-rust-client) ⭐ 2 | 🐛 1 | 🌐 Rust | 📅 2026-09-20 - A type-safe, async Rust client for the Shopify Admin API.

## Example Apps

### Shopify App Templates

* [Shopify App Template (React Router)](https://github.com/Shopify/shopify-app-template-react-router) ⭐ 197 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-08 - Template for Shopify apps using React Router for routing instead of Next.js or Remix.
* [Shopify Payments App Template (Remix)](https://github.com/Shopify/example-app--payments-app-template--remix) ⭐ 27 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-17 - Remix template for building Shopify apps with payments integration (Payments App API support). 🚀
* [Shopify Credit Card Payments Template (Remix)](https://github.com/Shopify/example-app--credit-card-payments-app-template--remix) ⭐ 16 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-17 - Remix example showing Credit Card Payments integration using Shopify’s Payments API. 🏦
...
* [Shopify App Node](https://github.com/Shopify/shopify-app-template-node) ⭐ 1,015 | 🐛 50 | 🌐 JavaScript | 📅 2026-08-05 - Boilerplate to create an embedded Shopify app made with Node, Next.js, Shopify-koa-auth, Polaris, and App Bridge React :sunny:.
...
* [Shopify App Template Remix](https://github.com/Shopify/shopify-app-template-remix) ⭐ 556 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-05 - A template for building a Shopify app using the Remix framework.
* [Shopify app with Next.js and Prisma ORM](https://github.com/kinngh/shopify-nextjs-prisma-app) ⭐ 511 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-11 - Starter template for building embedded Shopify apps using Next.js and Prisma ORM, preconfigured with essential integrations.
...
* [Shopify Discount App Components)](https://github.com/Shopify/discount-app-components) ⭐ 87 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-16 - A library of discounts-focused React components to help in building Shopify apps.
* [Shopify App Vue Template](https://github.com/Mini-Sylar/shopify-app-vue-template) ⭐ 85 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-03 - Create a Shopify App with node and vue 3.
* [SmallAwesomeShop](https://github.com/JsssCode/SmallAwesomeShop) ⭐ 42 | 🐛 3 | 🌐 TypeScript | 📅 2018-10-17 - An Angular 7 App example using Shopify's Storefront GraphQL API. ⚠️
...
* [shopify-app-php](https://github.com/Shopify/shopify-app-template-php) ⭐ 340 | 🐛 89 | 🌐 PHP | 📅 2026-08-05 - Example Shopify PHP app (Laravel).
...
* [partner-metrics](https://github.com/forsbergplustwo/partner-metrics) ⭐ 63 | 🐛 11 | 🌐 Ruby | 📅 2026-08-17 - Metrics Dashboard for Shopify Partners, on Rails. ⚠️
...
* [Theme Kit](https://github.com/Shopify/themekit) ⭐ 1,322 | 🐛 5 | 🌐 Go | 📅 2025-11-20 - Shopify theme development command line tool. ⚠️
* [Shopify CLI](https://github.com/Shopify/cli) ⭐ 750 | 🐛 159 | 🌐 TypeScript | 📅 2026-09-20 - CLI to build apps, themes, and hydrogen storefronts for Shopify 🚀.
...
* [zed-shopify-liquid](https://github.com/TheBeyondGroup/zed-shopify-liquid) ⭐ 27 | 🐛 4 | 🌐 Tree-sitter Query | 📅 2026-04-07
* [Shopify Liquid for VS Code](https://marketplace.visualstudio.com/items?itemName=Shopify.theme-check-vscode)

### AI tools

* [Agent plugins/extensions for CLIs and IDEs](https://github.com/shopify/shopify-ai-toolkit) ⭐ 557 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-18
...
* [Shopify App Detector](https://chrome.google.com/webstore/detail/shopify-app-detector-by-f/lhfdhjladfcmghahdbcmlceajdlbkale) - Detect which apps and what theme a Shopify store is using. [GitHub](https://github.com/feracommerce/shopify_app_detector) ⭐ 112 | 🐛 3 | 🌐 JavaScript | 📅 2024-02-01
...
* [Shopify Product CSVs](https://github.com/shopifypartners/product-csvs) ⭐ 406 | 🐛 2 | 📅 2023-03-30 - Get your Shopify development stores started with great product data.
...
Contributions are welcome! Please read the [contribution guidelines](https://github.com/julionc/awesome-shopify/blob/main/contributing.md) ⭐ 1,279 | 🐛 7 | 📅 2026-09-14 first.

Thanks to all [contributors](https://github.com/julionc/awesome-shopify/graphs/contributors) ⭐ 1,279 | 🐛 7 | 📅 2026-09-14 — you're awesome and this wouldn’t be possible without you! 🙌
