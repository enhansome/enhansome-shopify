...
* [Shopify Dawn](https://github.com/Shopify/dawn) ⭐ 3,085 | 🐛 27 | 🌐 Liquid | 📅 2026-08-10 - Official Online Store 2.0 theme.
* [Shopify Horizon](https://github.com/Shopify/horizon) ⭐ 460 | 🐛 29 | 🌐 Liquid | 📅 2026-09-21 - Flagship of Shopify’s next-gen themes.
...
* [Pilot (Weaverse Hydrogen Theme)](https://github.com/Weaverse/pilot) ⭐ 384 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-18 - Fully featured Shopify Hydrogen theme crafted for launching modern, high-performance headless storefronts. Includes TypeScript, Tailwind CSS, GraphQL code generation, React Router, Oxygen deployment, and customization via Weaverse Studio. 🚀
...
* [AEOrank](https://github.com/vinpatel/aeorank/tree/main/packages/shopify) ⭐ 14 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-21 - Hydrogen plugin that generates AI-readable files (llms.txt, ai.txt, CLAUDE.md, schema.json) so ChatGPT and Perplexity can find and cite your products.
...
* [Shopify UI Extensions](https://github.com/Shopify/ui-extensions) ⭐ 351 | 🐛 450 | 🌐 TypeScript | 📅 2026-09-21 – Repo for the public definition of Shopify’s UI extension APIs. Developers use this to build strongly-typed UI extensions for Shopify surfaces. 🧰
...
* [Shopify Checkout Sheet Kit (Android)](https://github.com/Shopify/checkout-sheet-kit-android) ⭐ 27 | 🐛 17 | 🌐 Kotlin | 📅 2026-09-21
...
* [Shopify Ruby API](https://github.com/Shopify/shopify_api) ⭐ 1,108 | 🐛 38 | 🌐 Ruby | 📅 2026-08-04
...
* [Shopify API and app tools for JavaScript](https://github.com/Shopify/shopify-app-js) ⭐ 540 | 🐛 135 | 🌐 TypeScript | 📅 2026-09-21
* [nestjs-shopify](https://github.com/nestjs-shopify/nestjs-shopify) ⭐ 151 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-21 - Packages to develop Shopify application using NestJS.

### DotNet

* [nozzlegear/ShopifySharp](https://github.com/nozzlegear/ShopifySharp) ⭐ 898 | 🐛 223 | 🌐 C# | 📅 2026-09-21 - A .NET library for Shopify.
...
* [Shopify Function Rust](https://github.com/Shopify/shopify-function-rust) ⭐ 47 | 🐛 12 | 🌐 Rust | 📅 2026-09-21
...
* [Shopify App Template (React Router)](https://github.com/Shopify/shopify-app-template-react-router) ⭐ 198 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-08 - Template for Shopify apps using React Router for routing instead of Next.js or Remix.
* [Shopify Payments App Template (Remix)](https://github.com/Shopify/example-app--payments-app-template--remix) ⭐ 27 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-21 - Remix template for building Shopify apps with payments integration (Payments App API support). 🚀
* [Shopify Credit Card Payments Template (Remix)](https://github.com/Shopify/example-app--credit-card-payments-app-template--remix) ⭐ 16 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-21 - Remix example showing Credit Card Payments integration using Shopify’s Payments API. 🏦
...
* [Shopify CLI](https://github.com/Shopify/cli) ⭐ 750 | 🐛 149 | 🌐 TypeScript | 📅 2026-09-21 - CLI to build apps, themes, and hydrogen storefronts for Shopify 🚀.
...
* [Agent plugins/extensions for CLIs and IDEs](https://github.com/shopify/shopify-ai-toolkit) ⭐ 563 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-18
